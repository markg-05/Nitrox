...
public class NitroxSettingsManager
{
    ...
    private void MakeSettings()
    {
        ...
        AddSetting("Nitrox_Settings_Gameplay", new Setting("Nitrox_Settings_EnableEnhancedSurfaceBreaches", NitroxPrefs.EnableEnhancedSurfaceBreaches, enabled => NitroxPrefs.EnableEnhancedSurfaceBreaches.Value = enabled));
        AddSetting("Nitrox_Settings_Gameplay", new Setting("Nitrox_Settings_SurfaceBreachMomentumRetention", NitroxPrefs.SurfaceBreachMomentumRetention,
